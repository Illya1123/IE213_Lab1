...
const FormInput = () => {
  ...
  return (
    <form onSubmit={handleSubmit}>
      ...
      <div className="Content2_Bai_4">
        <label>Họ tên học sinh:</label>
        <input
          value={studentName}
          onChange={(e) => setstudentName(e.target.value)}
          className="Input1_Bai_4"
          type="text"
          name="studentName"
          required
          disabled={submitted}
      ...
      <div className='Content1_Bai_4'>
        <label>Lớp:</label>
        <input
          value={className}
          onChange={(e) => setclassName(e.target.value)}
          className="Input2_Bai_4"
          type="text"
          name="className"
          required
          disabled={submitted}
      ...
      <div className='Content_Bai_4'>
        <textarea
          value={unfinishTask}
          onChange={(e) => setunfinishTask(e.target.value)}
          className="Input3_Bai_4"
          name="unfinishTask"
          style={{ height: '80px' }}
          required
          disabled={submitted}
      ...
      <div className="GhiNhan">
        <button className="Submit_Bai+4" type="submit" disabled={submitted}>
          Ghi Nhận
        </button>
      </div>
    </form>
